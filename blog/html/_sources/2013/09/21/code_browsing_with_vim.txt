...
ctags is a program which generate tag files for programs. The tag files lets us
jump
to different sections of code very fast.  
...
a long code file. With ctags and vim I can do the same in a more efficient manner.
Add this line to your `~/.vimrc` and it will generate tag file everytime you save your code
